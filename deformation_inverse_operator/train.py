...
Usage:
    ...
    # Multi-GPU via DDP
    torchrun --nproc_per_node=4 -m deformation_inverse_operator.train --use_ddp
"""
import os
import sys
import argparse
...
def train(rank: int, world_size: int, config: InverseOperatorConfig, data_config: DatasetConfig):
