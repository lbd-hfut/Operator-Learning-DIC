...
Usage:
    ...
    python -m deformation_inverse_operator.train --config config/training.yaml

    # Resume from checkpoint
    python -m deformation_inverse_operator.train --resume checkpoints/dic_operator_last.pt
...
def main():
    ...
    resume_path = args.resume or yaml_cfg.get("resume_b_from")
    if not resume_path:
